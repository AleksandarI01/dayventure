                ...
                <div className="flex flex-col w-8/12 align-center">
                    ...
                    <div className="flex w-full justify-start">
                        <ul className="list-none flex flex-row h-full">
                            <li id={"popular-sightseeing"} className={styleSightseeing} onClick={onHandlePopularClick}>
                                Sightseeing
                            </li>
                            <li id={"popular-culinary"} className={styleCulinary} onClick={onHandlePopularClick}>
                                Culinary
                            </li>
                            <li id={"popular-shopping"} className={styleShopping} onClick={onHandlePopularClick}>
                                Shopping
                            </li>
                            <li id={"popular-nightlife"} className={styleNightlife} onClick={onHandlePopularClick}>
                                Nightlife
                            </li>
                            <li id={"popular-adventure"} className={styleAdventure} onClick={onHandlePopularClick}>
                                Adventure
                            </li>
                        </ul>
                    </div>
