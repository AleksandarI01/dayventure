...
const ImageTrip = () => {
  return (
    <>
      <div className="w-[272px] h-[400px] border border-solid rounded-md border-venture-gray">
        <div
          className="h-[100%] w-[100% ] shrink-0 flex flex-col border border-solid rounded-md bg-cover"
        ...
        >
          ...
          <div className="h-[52%] w-[100%] shrink-0 flex flex-col"></div>
